...
import { Github, Download, MapPin, Circle, Sparkles, ArrowRight } from "lucide-react";
      ...
      {particles.map((p) => (
        <motion.div
          ...
          style={{
            ...
            width: p.size,
            height: p.size,
            background: p.id % 3 === 0 ? ACCENT : p.id % 3 === 1 ? "#a855f7" : "#06b6d4",
          }}
          animate={{
            y: [-20, 20, -20],
            x: [-10, 10, -10],
    ...
    >
      ...
      >
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at 50% 100%, ${ACCENT}25, rgba(168,85,247,0.1) 50%, transparent 70%)`,
            filter: "blur(30px)",
        ...
        >
          {hovered && (
            <div className="absolute inset-0 z-20 pointer-events-none rounded-[2rem] overflow-hidden" style={{ opacity: 0.12 }}>
              <motion.div
        ...
        {[
          { text: "5+ yrs exp 🚀", pos: "-top-5 -right-8", delay: 0.5, dir: -6 },
          { text: "30+ projects ⚡", pos: "-bottom-5 -left-8", delay: 0, dir: 6 },
        ].map((badge) => (
          <motion.div
            key={badge.text}
        ...
        />
        <div className="absolute -bottom-12 -right-12 w-2 h-2 rounded-full pointer-events-none"
          style={{ background: ACCENT, boxShadow: `0 0 8px ${ACCENT}`, marginLeft: "88px" }} />
      </motion.div>
    </motion.div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 right-1/3 w-[600px] h-[600px] rounded-full pointer-events-none"
        style={{ background: `radial-gradient(circle, ${ACCENT}07 0%, transparent 65%)`, filter: "blur(80px)" }} />
      <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(168,85,247,0.07) 0%, transparent 65%)", filter: "blur(80px)" }} />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              <p className="text-sm font-mono mb-3" style={{ color: "rgba(255,255,255,0.25)", letterSpacing: "0.15em" }}>
                HELLO WORLD —
              </p>
              <h1
              ...
              >
                <span style={{ color: "rgba(255,255,255,0.9)" }}>Hi, I&apos;m</span>
                <br />
                <span
                  style={{
            ...
            <motion.div
              ...
              className="h-11 mb-7"
            >
              <p className="text-xl lg:text-2xl font-semibold" style={{ fontFamily: "'Cabinet Grotesk', sans-serif", color: "rgba(255,255,255,0.35)", letterSpacing: "-0.02em" }}>
                {typedText}
                <span className="inline-block w-[2px] h-6 ml-1 align-middle animate-blink rounded-full" style={{ background: ACCENT }} />
              </p>
            </motion.div>
            ...
            <motion.p
              ...
              style={{ color: "rgba(255,255,255,0.38)", fontFamily: "'Cabinet Grotesk', sans-serif", lineHeight: "1.8" }}
            >
              {personalInfo.bio}
            </motion.p>
        ...
        >
          <div className="absolute inset-0 -top-4 rounded-3xl pointer-events-none"
          ...
          <div className="grid grid-cols-3 gap-0 relative">
            {stats.map((stat, i) => (
              <div key={stat.label} className="relative">
                ...
                >
                  <div
                    className="font-black mb-2 tabular-nums transition-all duration-300"
                    style={{
                  ...
                  <div className="text-xs font-mono tracking-widest uppercase" style={{ color: "rgba(255,255,255,0.25)" }}>
                    {stat.label}
                  </div>
                  <div
