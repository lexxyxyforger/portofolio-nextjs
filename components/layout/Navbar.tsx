...
export function Navbar() {
  ...
  const handleLogoClick = async () => {
    ...
    if (logoClickCount.current >= 5) {
      ...
      confetti({ particleCount: 220, spread: 110, origin: { y: 0.05 }, colors: [ACCENT, "#f97316", "#ffffff", "#a855f7"] });
    }
  };
      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: scrolled
              ? `0 8px 40px rgba(0,0,0,0.6), 0 0 0 0.5px rgba(255,255,255,0.05), 0 0 30px ${ACCENT}10`
        ...
        >
          <div className="flex items-center justify-between px-5 py-3.5">
            ...
            >
              <div
                className="w-8 h-8 rounded-xl flex items-center justify-center relative overflow-hidden transition-all duration-300"
                style={{
              ...
              <span
                ...
                style={{ fontFamily: "'Syne', sans-serif", color: "rgba(255,255,255,0.92)", letterSpacing: "-0.03em" }}
              >
                  ...
                  >
                    {isActive && (
                      <motion.div
                        ...
                        style={{ background: `linear-gradient(135deg, ${ACCENT}, #f97316)`, zIndex: -1, boxShadow: `0 4px 16px ${ACCENT}50` }}
          ...
          >
            <motion.div
              ...
              style={{
                ...
                boxShadow: `0 40px 80px rgba(0,0,0,0.8), 0 0 0 0.5px ${ACCENT}15, 0 0 60px ${ACCENT}08`,
              }}
            ...
            >
              ...
              <div className="absolute -top-20 -right-20 w-48 h-48 rounded-full pointer-events-none" style={{ background: `radial-gradient(circle, ${ACCENT}12, transparent 70%)` }} />
              ...
              <div className="relative z-10 p-7">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-lg leading-none" style={{ fontFamily: "'Syne', sans-serif", color: "rgba(255,255,255,0.92)" }}>
                        Shortcuts
                      </h3>
                      <p className="text-xs mt-0.5" style={{ color: "rgba(255,255,255,0.25)", fontFamily: "monospace" }}>keyboard navigation</p>
                    </div>
                  </div>
                  <motion.button
                ...
                <div className="space-y-1">
                  {navLinks.map((l, i) => (
                    <motion.div
                      ...
                      className="flex justify-between items-center py-2.5 px-3 rounded-xl cursor-pointer transition-all duration-200 group"
                  ...
                  <div className="flex justify-between items-center py-2.5 px-3 mt-1 pt-3"
                    style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
                    <span className="text-sm" style={{ color: "rgba(255,255,255,0.35)", fontFamily: "'DM Sans', sans-serif" }}>Toggle panel</span>
                    <kbd className="px-2.5 py-1 rounded-lg text-xs font-bold"
                      style={{ fontFamily: "'JetBrains Mono', monospace", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.5)" }}>
                      ?
                    </kbd>
                  </div>
                </div>

                <p className="text-xs text-center mt-5 pt-4" style={{ borderTop: "1px solid rgba(255,255,255,0.05)", color: "rgba(255,255,255,0.2)", fontFamily: "monospace" }}>
